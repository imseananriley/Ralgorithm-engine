...
3. Production integration: card classification and strategic dispatch now read from the registry. Payment-directed compiled actions, full packed-state generation, and the deck-specific compiled policy remain the next migration stages.
...
The current generation comparison is documented in [docs/generation3_benchmark.md](docs/generation3_benchmark.md).
