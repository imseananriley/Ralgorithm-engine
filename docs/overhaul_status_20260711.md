...
| Performance gates | Partial | Opening direct/micro parity, counters, mergeable latency histograms, throughput, and exact-result 1/2/4-worker scaling are present. Allocation totals and controlled 8-worker/pod curves remain. |
